...
gauss_priors = [1, 2, 3, 4, 5, 6, 7, 8]  # DWT levels using a Gaussian (white noise) prior. For a white noise prior, include all levels in this list.
...
# Output paths.
saveDir = '/sdf/group/kipac/users/mati/WN_prior_best_model_256_kap_noise_10.0/'  # Directory to save the trained model (update as needed).
plotSaveDir = 'plots_WN_prior_best_model_256_kap_noise_10.0/'  # Directory to save plots generated by Sample_test.py.
