...
perm = "invconv"
coupling = "checker"  #or "rqs or checker"
network = ['ConvNet'] * 10
y_classes = None     
y_learn_top = False
y_condition = False
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/best_model_64_tsz_checker_nyquest_noise/'
plotSaveDir = 'plots_64_tsz_checker_nyquest_noise/' 