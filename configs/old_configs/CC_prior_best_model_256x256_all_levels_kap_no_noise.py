...
std_path = 'norm_stds/256x256_final_mean_stats_all_levels_kappa_cib_no_noise.json'  # Path to the normalization constants.
ps_path = 'ps/256x256_kappa_no_noise_yuuki_kap_cib/dwtlevel'  # Path to the folder containing power spectra for all DWT components at each level.

# Output paths.
saveDir = '/sdf/group/kipac/users/mati/CC_prior_best_model_256_kap_no_noise/'  # Directory to save the trained model (update as needed).
plotSaveDir = 'plots_CC_prior_best_model_256_kap_no_noise/'  # Directory to save plots generated by Sample_test.py.
