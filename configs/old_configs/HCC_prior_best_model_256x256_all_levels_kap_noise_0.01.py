...
# Output paths.
saveDir = '/sdf/group/kipac/users/mati/HCC_prior_best_model_256_kap_noise_0.01/'  # Directory to save the trained model (update as needed).
plotSaveDir = 'plots_HCC_prior_best_model_256_kap_noise_0.01/'  # Directory to save plots generated by Sample_test.py.
