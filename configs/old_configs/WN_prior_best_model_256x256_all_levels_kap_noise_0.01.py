...
gauss_priors = [8]  # DWT levels using a Gaussian (white noise) prior. For a white noise prior, include all levels in this list.
...
dataset_path = '/sdf/group/kipac/users/mati/yukki_sim_train_256x256/'  # Path to the training dataset.
val_dataset_path = '/sdf/group/kipac/users/mati/yukki_sim_train_256x256/'  # Path to the validation dataset.
...
std_path = 'norm_stds/256x256_final_mean_stats_all_levels_kappa_cib_kappa_noise_0.01.json'  # Path to the normalization constants.
ps_path = 'ps/256x256_kappa_noise_0.01_yuuki_kap_cib/dwtlevel'  # Path to the folder containing power spectra for all DWT components at each level.

# Output paths.
saveDir = '/sdf/group/kipac/users/mati/WN_prior_best_model_256_kap_noise_0.01/'  # Directory to save the trained model (update as needed).
plotSaveDir = 'plots_WN_prior_best_model_256_kap_noise_0.01/'  # Directory to save plots generated by Sample_test.py.
