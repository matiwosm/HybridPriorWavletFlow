...
model = "waveletflow"
stepsPerResolution = [2, 2, 2, 4, 4, 4, 16, 16, 16, 16, 16]
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/best_model_64_noised_tsz_resnet/'
plotSaveDir = 'plots_64_noised_tsz_resnet/' 