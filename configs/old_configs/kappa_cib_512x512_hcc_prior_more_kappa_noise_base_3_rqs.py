...
LU = True
#prior
gauss_priors = [3,4,5,6,7,8] #set this for HCC prior. For WN prior, add all the layers to this list
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/real_hcc_model_512_noised_kappa_nyquest_more_noise_base3_rqs/'
plotSaveDir = 'plots_hcc_model_512_noised_kappa_nyquest_more_noise_base_3_rqs/'