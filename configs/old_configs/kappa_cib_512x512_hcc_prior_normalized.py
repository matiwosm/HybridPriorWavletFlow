...
LU = True
#prior
gauss_priors = [1] #set this for HCC prior. For WN prior, add all the layers to this list
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/real_hcc_prior_model_512_noised_kappa_nyquest_noise_normalized/'
plotSaveDir = 'plots_hcc_model_512_noised_kappa_nyquest_noise_normalized/'