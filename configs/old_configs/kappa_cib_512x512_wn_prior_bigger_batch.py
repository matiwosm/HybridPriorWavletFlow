...
LU = True
#prior
gauss_priors = [1,2,3,4,5,6,7,8,9] #set this for HCC prior. For WN prior, add all the layers to this list
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/wn_model_512_noised_kappa_nyquest_noise_bigger_batch/'
plotSaveDir = 'plots_wn_model_512_noised_kappa_nyquest_noise_bigger_batch/'