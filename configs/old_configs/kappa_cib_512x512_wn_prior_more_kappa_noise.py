...
model = "waveletflow"
stepsPerResolution = [2, 2, 4, 8, 8, 8, 8, 8, 8, 16, 16]
...
dataset_path = '/sdf/data/kipac/u/mati/yuuki_forground_data/yukki_sim_train_512x512/'
val_dataset_path = '/sdf/data/kipac/u/mati/yuuki_forground_data/yukki_sim_val_512x512/'
sample_batch_size = 32
normalize = [None] + [False] + [False] * 8
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/hcc_model_512_noised_kappa_nyquest_more_noise/'
plotSaveDir = 'plots_wn_model_512_noised_kappa_nyquest_more_noise/'