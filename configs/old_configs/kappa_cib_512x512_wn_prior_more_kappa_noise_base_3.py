...
#output paths
saveDir = '/sdf/group/kipac/users/mati/hcc_model_512_noised_kappa_nyquest_more_noise_base3/'
plotSaveDir = 'plots_wn_model_512_noised_kappa_nyquest_more_noise_base_3/'