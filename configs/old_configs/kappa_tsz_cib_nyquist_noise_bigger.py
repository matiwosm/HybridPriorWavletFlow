...
model = "waveletflow"
stepsPerResolution = [8, 16, 16, 16, 32, 32, 16, 16, 16, 16, 16]
...
#output paths
saveDir = '/sdf/group/kipac/users/mati/64x64_kappa_tsz_cib_trial_2_bigger/'
plotSaveDir = 'plots_64x64_kappa_tsz_cib_bigger/'