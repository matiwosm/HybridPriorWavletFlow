...
class Affine(nn.Module):
    ...
    def get_param(self, x, conditioning):
        ...
        # print('z1', torch.any(torch.isnan(z1)))
        # print('z1', torch.any(torch.isnan(z2)))
        ...
        # print('s', torch.any(torch.isnan(s)))
        # print('t', torch.any(torch.isnan(t)))
        s = torch.sigmoid(s + 2.0)
        # print('s after', torch.any(torch.isnan(s)))
        return s, t, z1, z2
