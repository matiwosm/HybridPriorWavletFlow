...
#SBATCH --job-name=HCC_tsz_test%a
#SBATCH --output=logs/HCC_tsz_test%a_log.txt
#SBATCH --error=logs/HCC_tsz_test%a_error.txt
...
python train.py --level $SLURM_ARRAY_TASK_ID --config configs/example_config_hcc_prior_tsz.py
